...
command = "/projects/rmorin/git/bioscripts/plotProtein.R %s %s %s %s %s %s %s yes %s no" % (mut_file,features_file,exon_file,splice_file,protein_length,gene_symbol,tick_spacing,out_file)
args = command.split(" ")
print command
#run the command
